  ...
  $("#team").html('<div class="testimonial-box"> <div class="containernya"> <div class="rowaa"> <div class="col-lg-12" id="ignielRandom"></div> </div> </div> </div> ');
...
$('#team').after('<script src="'+window.location.origin+'/feeds/posts/summary?alt=json-in-script&max-results=0&callback=randomPost"><\/script>');  
